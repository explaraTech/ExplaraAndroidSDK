...
//            });
    ...
    public synchronized void payUsingCitrusCash(final PaymentType.CitrusCash citrusCash, final Callback<TransactionResponse> callback, int theme) {
        this.theme = theme;
        payUsingCitrusCash(citrusCash, callback);
    }
