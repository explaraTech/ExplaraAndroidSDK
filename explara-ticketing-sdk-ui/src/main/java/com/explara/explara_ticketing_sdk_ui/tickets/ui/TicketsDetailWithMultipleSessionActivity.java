 ...
 */
public class TicketsDetailWithMultipleSessionActivity extends BaseWithOutNavActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TicketsManager.getInstance().cleanSelectedSessionData();
    ...
    protected void addContentFragment() {
        displayBackButton();
        FragmentHelper.replaceContentFragment(this, R.id.fragment_container, TicketsDetailsWithMultipleSessionFragment.getInstance(getIntent()));
    }
