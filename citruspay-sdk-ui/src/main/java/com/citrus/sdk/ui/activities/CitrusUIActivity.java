...
//        setActionBarTitle(UIConstants.SCREEN_SHOPPING);
    ...
    public void onWalletTransactionComplete(ResultModel resultModel) {
        ...
        intent.putExtra(Constants.INTENT_EXTRA_TRANSACTION_RESPONSE, resultModel.getTransactionResponse());
        intent.putExtra(ResultFragment.ARG_RESULT, resultModel);
        context.setResult(RESULT_OK, intent);
        finish();

//        setDataToSendBackToParentActivity(intent);
